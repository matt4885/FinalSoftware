...
public class SetCommissionRate extends javax.swing.JPanel {
    ...
    public String setCommissionRateText() {
        String output;
        String comRate = dbConnect.getCommission();
        if (comRate.equals(""))
            comRate = "0.05";
        //output = "Current Commission Rate is " + client.getCommissionRate();
        output = "Current Commission Rate is " + comRate;
        return output;
    }
    ...
    private void initComponents() {
        ...
        jInternalFrame1.setBackground(new java.awt.Color(255, 102, 102));
        ...
        comboBoxCommissionRate.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "0", ".005", ".010", ".015", ".020", ".025", ".030", ".035", ".040", ".045" }));
        ...
        comboBoxCommissionRate.setBounds(143, 182, 86, 59);
    ...
    private void comboBoxCommissionRateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_comboBoxCommissionRateActionPerformed
        ...
        //client.setCommissionRate((Double.parseDouble(commRate)));
        //System.out.println("Test point 9 commission rate is: " + client.getCommissionRate());
        dbConnect.setCommission((commRate));
        System.out.println("Test point 9 commission rate is: " + dbConnect.getCommission());

        refreshLabelCommissionRate();
